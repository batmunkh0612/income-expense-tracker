  ...
  const renderDialog = () => (
    <Dialog>
      <DialogTrigger asChild>
        <Button ref={btnRef} className="flex gap-1 h-8 rounded-[20px] bg-[#0166FF]" >
        ...
        <DialogFooter className="flex sm:justify-start">
          <div className="flex flex-col flex-1 gap-5 px-6 py-5">
            ...
            {renderFormField("Category", "category", 
              <Select
                onValueChange={(value) => handleInputChange(value, "category_id")}
              >
                <SelectTrigger>
